...
function javaScriptFindGlobal7(indexHTML, indexModel, codeParts) {
...
function testFindGlobal7() {
 ...
 `;
  ...
  const result = javaScriptFindGlobal7(1, 2, jsCodes);

  console.log('testFindGlobal7');
